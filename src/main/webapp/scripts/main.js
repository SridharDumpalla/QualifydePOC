    ...
    var runPrepJS = function () {
		...
		$(window).load(function() {
			...
			var scripts = {
				...
				// HIGH PRIORITY
				gmap: 			 '/plugins/map/gmaps.min.js',
				jquerymap:		 '/plugins/gmap/jquery.ui.map.js',
				mixitup: 		 '/plugins/mixitup/jquery.mixitup.min.js',
				mpopup: 		 '/plugins/mfpopup/dist/jquery.magnific-popup.min.js',
				chosen:		  	 '/plugins/chosen/chosen.jquery.min.js',
				moment:		 	 '/plugins/daterange/moment.min.js',
				globalize:   	 '/plugins/globalize/globalize.js',
	
				// FORM PICKERS
				cpicker: 	  	 '/plugins/colorpicker/bootstrap-colorpicker.js',
				timepicker:      '/plugins/timepicker/bootstrap-timepicker.min.js',
				datepicker:      '/plugins/datepicker/bootstrap-datepicker.js',
				daterange: 	     '/plugins/daterange/daterangepicker.js',
				
				// FORMS
				validate:		 '/plugins/validate/jquery.validate.js',
				masked: 	 	 '/plugins/jquerymask/jquery.maskedinput.min.js',
				
				// FORMS TOOLS
				holder: 	     '/plugins/bootstrap/holder.js',
				tagmanager:      '/plugins/tags/tagmanager.js',
				gritter:         '/plugins/gritter/js/jquery.gritter.min.js',
				ladda:           '/plugins/ladda/ladda.min.js',
				switcher:        '/plugins/formswitch/js/bootstrap-switch.min.js',
				paginator:		 '/plugins/bootstrap/paginator/src/bootstrap-paginator.js',
				knob:            '/plugins/jquerydial/jquery.knob.js',
				rangeslider:     '/plugins/rangeslider/jQAllRangeSliders.min.js',
				
				// MED PRIORITY - Large File sizes
				charts:       	 'js/charts.js',
				ckeditorCDN:     'http://cdnjs.cloudflare.com/ajax/libs/ckeditor/4.0.1/ckeditor.js',
				xedit: 			 '/plugins/editors/xeditable/js/bootstrap-editable.js',
				summernote:      '/plugins/editors/summernote/summernote.js',
				elfinder: 		 '/plugins/elfinder/js/elfinder.min.js',
				countdown:       '/plugins/countdown/jquery.countdown.js',
				jcrop: 			 '/plugins/imagecrop/js/jquery.Jcrop.min.js',
				imagezoom: 		 '/plugins/imagezoom/jquery.elevatezoom.min.js',
				sketchpad:       '/plugins/notepad/wPaint.min.js',
				scrollto: 		 '/plugins/scrollto/jquery.scrollTo-1.4.3.1-min.js',
				fileupload:      '/plugins/bootstrap/fileupload/fileupload.js',
				fitvids:		 '/plugins/fitvids/jquery.fitvids.js'	,
